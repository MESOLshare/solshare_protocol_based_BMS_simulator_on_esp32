...
void unix_ts()
{
  ...
  int response_data = 0x00;
  result_packet(TS_UNIX, response_data);
}
...
void time_before_sleep()
{
  ...
  int response_data = 0x00;
  result_packet(TIME_TO_SLEEP, response_data);
}
...
void current_uart_b()
{
  ...
  int response_data = 0x00;
  result_packet(CURR_UART_B, response_data);
}
...
void cell_OVP()
{
  ...
  int response_data = 0x00;
  result_packet(CELL_OVP, response_data);
}
...
void cell_OVPD()
{
  ...
  int response_data = 0x00;
  result_packet(CELL_OVPD, response_data);
}
...
void cell_UVP()
{
  ...
  int response_data = 0x00;
  result_packet(CELL_UVP, response_data);
}
...
void cell_UVPD()
{
  ...
  int response_data = 0x00;
  result_packet(CELL_UVPD, response_data);
}
...
void pack_OVP()
{
  ...
  int response_data = 0x00;
  result_packet(PACK_OVP, response_data);
}
...
void pack_OVPD()
{
  ...
  int response_data = 0x00;
  result_packet(PACK_OVPD, response_data);
}
...
void pack_UVP()
{
  ...
  int response_data = 0x00;
  result_packet(PACK_UVP, response_data);
}
...
void pack_UVPD()
{
  Serial.println("pack_UVP");
  int response_data = 0x00;
  result_packet(PACK_UVPD, response_data);
}
...
void crg_OCP()
{
  ...
  int response_data = 0x00;
  result_packet(CRG_OCP, response_data);
}
...
void crg_OCPD()
{
  ...
  int response_data = 0x00;
  result_packet(CRG_OCPD, response_data);
}
...
void crg_OCPRD()
{
  ...
  int response_data = 0x00;
  result_packet(CRG_OCPRD, response_data);
}
...
void dscrg_OCP()
{
  ...
  int response_data = 0x00;
  result_packet(DSCRG_OCP, response_data);
}
...
void dscrg_OCPD()
{
  ...
  int response_data = 0x00;
  result_packet(DSCRG_OCPD, response_data);
}
...
void dscrg_OCPRD()
{
  ...
  int response_data = 0x00;
  result_packet(DSCRG_OCPRD, response_data);
}
...
void crg_OTP()
{
  ...
  int response_data = 0x00;
  result_packet(CRG_OTP, response_data);
}
...
void crg_OTPD()
{
  ...
  int response_data = 0x00;
  result_packet(CRG_OTPD, response_data);
}
...
void crg_OTPRD()
{
  ...
  int response_data = 0x00;
  result_packet(CRG_OTPRD, response_data);
}
...
void crg_UTP()
{
  ...
  int response_data = 0x00;
  result_packet(CRG_UTP, response_data);
}
...
void crg_UTPD()
{
  ...
  int response_data = 0x00;
  result_packet(CRG_UTPD, response_data);
}
...
void crg_UTPRD()
{
  ...
  int response_data = 0x00;
  result_packet(CRG_UTPRD, response_data);
}
...
void dscrg_OTP()
{
  ...
  int response_data = 0x00;
  result_packet(DSCRG_OTP, response_data);
}
...
void dscrg_OTPD()
{
  ...
  int response_data = 0x00;
  result_packet(DSCRG_OTPD, response_data);
}
...
void dscrg_OTPRD()
{
  ...
  int response_data = 0x00;
  result_packet(DSCRG_OTPRD, response_data);
}
...
void dscrg_UTP()
{
  Serial.println("crg_UTP");
  int response_data = 0x00;
  result_packet(DSCRG_UTP, response_data);
}
...
void dscrg_UTPD()
{
  Serial.println("crg_UTPD");
  int response_data = 0x00;
  result_packet(DSCRG_UTPD, response_data);
}
...
void dscrg_UTPRD()
{
  Serial.println("crg_UTPRD");
  int response_data = 0x00;
  result_packet(DSCRG_UTPRD, response_data);
}
